...
export function validatePluginManifest(input) {
  ...
  const validAction = (x) => isObject(x) && idPattern.test(x.id) && typeof x.label === "string" && ["content","user","site"].includes(x.scope) && (input.contractVersion !== CONTRACT_VERSION_V3 || validActionSchema(x.inputSchema));
