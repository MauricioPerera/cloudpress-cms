...
for (const required of ["/api/admin/content?contentType", "/api/admin/plugin-meta", "CloudPressUI.confirm"]) assert.ok(pluginContent.includes(required), `El editor base de plugin debe incluir ${required}.`);
