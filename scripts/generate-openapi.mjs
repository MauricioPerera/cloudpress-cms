  ...
  components: {
    ...
    schemas: {
      ...
      AgentRuntimeRequest: { description: "Una sola operación de runtime, autenticada con una capacidad de agente ligada a un perfil activo.", oneOf: [
        ...
        { type: "object", required: ["action", "jobId", "leaseId", "estimatedInputTokens", "estimatedOutputTokens"], properties: { action: { enum: ["route_model", "invoke_model"] }, jobId: { type: "string", format: "uuid" }, leaseId: { type: "string", format: "uuid" }, modelId: { type: "string", maxLength: 120 }, estimatedInputTokens: { type: "integer", minimum: 0, maximum: 10000000 }, estimatedOutputTokens: { type: "integer", minimum: 0, maximum: 10000000 }, prompt: { type: "string", minLength: 1, maxLength: 16000, description: "Requerido únicamente por invoke_model." } }, additionalProperties: false },
