...
for (const table of ["agent_runtime_jobs", "agent_context_entries", "agent_memories", "agent_messages", "agent_model_catalog", "agent_model_usage"]) {
...
database.close();
console.log(JSON.stringify({ ok: true, checks: ["runtime-tables", "runtime-job-insert", "foreign-key-integrity"] }));
