...
console.log(JSON.stringify({ ok: true, checks: ["cross-origin-rejected", "cross-site-metadata-rejected", "same-origin-accepted", "fetch-metadata-accepted", "webhook-token-exempt", "approval-token-exempt", "recovery-token-exempt"] }));
